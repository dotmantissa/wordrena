...
export function BiomeScene({
  ...
  return (
    <section
      className={clsx(
        "relative isolate min-h-72 overflow-hidden rounded-lg border border-white/10 bg-void",
        className
      )}
      style={{ color: tone }}
    >
      <svg
        ...
        aria-hidden
      >
        <rect width="1000" height="420" fill="#181525" />
        <path d="M0 315 150 180l140 104 150-175 142 156 126-121 162 151 130-98v223H0Z" fill={tone} opacity=".12" />
        <path d="M0 340 170 250l125 78 168-132 142 130 164-87 231 101v80H0Z" fill={soft} opacity=".1" />
        <path d="M0 337c180-35 318-21 463 13 151 36 316 42 537-3v73H0Z" fill="#100e19" />
        <g stroke={tone} opacity=".16">
      ...
      <div className="absolute left-4 top-4 max-w-[65%]">
        ...
        <p className="mt-1 font-mono text-[10px] uppercase text-ink-faint">
          {source === "open-meteo" ? "Live sky reading" : "Calm fallback"}
        </p>
      </div>
